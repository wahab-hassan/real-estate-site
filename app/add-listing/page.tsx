...
const amenities = [
  ...
  { value: "airport_pickups", label: "Airport pick-up" },
  { value: "baby_crib", label: "Baby crib" },
  { value: "baby_stroller", label: "Baby stroller" },
  { value: "bathtub", label: "Bathtub" },
  { value: "bbq_grill", label: "BBQ Grill" },
  { value: "beachfront", label: "Beachfront" },
  { value: "bed_linens_towels", label: "Bed linens, towels" },
  { value: "blender", label: "Blender" },
  { value: "breakfast", label: "Breakfast" },
  { value: "breakfast_free", label: "Breakfast (free)" },
  { value: "car_parking", label: "Car Parking" },
  { value: "coffee_maker", label: "Coffee Maker" },
  { value: "cooking_basics", label: "Cooking basics" },
  { value: "dining_table", label: "Dining table" },
  { value: "dishes_silverware", label: "Dishes and silverware" },
  { value: "extra_bed", label: "Extra bed" },
  { value: "fire_extinguisher", label: "Fire extinguisher" },
  { value: "first_aid_kit", label: "First aid kit" },
  { value: "garden_backyard", label: "Garden/Backyard" },
  ...
  { value: "outdoor_bbq", label: "Outdoor BBQ" },
  { value: "outdoor_furniture", label: "Outdoor furniture" },
  { value: "outdoor_shower", label: "Outdoor Shower" },
  { value: "oven", label: "Oven" },
  { value: "patio_balcony_private", label: "Patio or Balcony (Private)" },
  { value: "patio_balcony_shared", label: "Patio or Balcony (Shared)" },
  { value: "pool_gate", label: "Pool gate" },
  ...
  { value: "safe_box", label: "Safe Box" },
  { value: "saltwater_pool", label: "Saltwater Pool" },
  ...
  { value: "pool_private", label: "Pool private" },
